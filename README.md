...
<img src="https://latex.codecogs.com/gif.latex?R(s,t)=\frac{E[(X_s-\mu_s)(X_t-\mu_t)]}{\sigma_s\sigma_t}" />


- 如果X为广义平稳过程，则$x_t$的期望$\mu_t$以及标准差$\sigma_t$不随时间t变化，则自相关函数可以表示为时间延迟$\tau$的函数，如下


<img src="https://latex.codecogs.com/gif.latex?R(\tau)=\frac{E[(X_t-\mu)(X_{t+\tau}-\mu)]}{\sigma^2}" />
